...
const ORDER_STATUSES = [
    ...
    { value: 'SERVED', label: 'Served', color: 'bg-teal-100 text-teal-700' },
...
const AdminOrdersPage = () => {
    ...
    const handleStatusChange = async (orderId: string, newStatus: string) => {
        try {
            ...
            ui.alertSuccess("Status updated successfully");
            fetchOrders();
        } catch (error) {
            ui.alertError("Failed to update status");
        }
    };
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-gray-800 tracking-tight">Order Management</h1>
                    <p className="text-sm text-gray-500 font-medium mt-1">Track and process customer orders</p>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="bg-gray-50 border-b border-gray-100">
                                <tr>
                                    <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Order ID / Table</th>
