    ...
    <header className="bg-white border-b border-border-light sticky top-0 z-30 px-4 md:px-10 py-3">
      <div className="max-w-[1200px] mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
            {variant === 'default' ? (
                <>
                    <Link to="/tracking" className="p-2 text-text-secondary hover:text-primary transition-colors relative" title="Order Tracking">
                        <ShoppingBag size={22} />
                    </Link>
                    <Link to="/admin" className="p-2 text-text-secondary hover:text-primary transition-colors" title="Admin">
                        <User size={22} />
                    </Link>
                </>
            ) : (
